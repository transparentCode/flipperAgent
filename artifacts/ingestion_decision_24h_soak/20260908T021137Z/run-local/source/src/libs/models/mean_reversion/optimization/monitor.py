"""CLI monitor for MeanReversion optimization studies.

Usage:
    PYTHONPATH=src python -m libs.models.mean_reversion.optimization.monitor
"""
...
def main() -> None:
    print("MeanReversion optimization monitor")
