...
DEFAULT_REGIME_OPTIMIZATION_SETTINGS: dict[str, Any] = {
    ...
    "probability_ladder": {
        ...
        "feature_sets": [
            ...
            ["fwd_vol_ewma", "vol_percentile", "changepoint_prob", "cp_entropy"],
            ["fwd_vol_ewma", "vol_percentile", "changepoint_prob", "hurst"],
        ],
        "target_kind": "vol_expansion",
        "target_kinds": ["vol_expansion", "oi_expansion", "funding_divergence", "oi_vol_composite"],
        "target_horizon": 5,
        "target_horizons": [3, 5, 10],
        "target_vol_lookback": 20,
        "shuffle_seed": c.SEED,
        "null_controls": ["circular_shift", "block_shuffle"],
        "null_shift_bars": 720,
        "null_block_bars": 96,
        ...
        "bucket_spread_weight": 0.5,
        "null_bucket_spread_weight": 0.5,
        "min_oos_auc": 0.55,
        "min_auc_lift_vs_null": 0.0,
        "min_brier_lift_vs_null": 0.0,
        "min_bucket_spread_lift_vs_null": 0.0,
        "min_sharpe_lift": 0.05,
    ...
    "rolling_probability_ladder": {
        ...
        "min_median_bucket_spread_lift": 0.0,
    },
    "model_selection_ladder": {
        ...
        "probability_validation_weight": 0.25,
        ...
        "min_total_return_lift": 0.0,
        "min_drawdown_improvement": 0.0,
        "min_risk_drawdown_improvement": 0.0,
        "min_risk_null_drawdown_improvement": 0.0,
        "min_risk_total_return_lift": 0.0,
        "min_risk_null_total_return_lift": 0.0,
        "min_avg_position": 0.05,
    },
    "rolling_model_selection_ladder": {
        ...
        "min_promoted_folds": 2,
        "min_pass_rate": 0.60,
        "min_median_sharpe_lift": 0.0,
        "min_median_null_sharpe_lift": 0.0,
        "min_median_auc_lift": 0.0,
        "min_risk_promoted_folds": 2,
        "min_risk_pass_rate": 0.60,
        "min_median_risk_drawdown_improvement": 0.0,
        "min_median_risk_null_drawdown_improvement": 0.0,
        "min_median_risk_total_return_lift": 0.0,
        "min_median_risk_null_total_return_lift": 0.0,
    },
