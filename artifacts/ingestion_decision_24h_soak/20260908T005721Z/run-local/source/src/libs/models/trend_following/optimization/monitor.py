"""CLI monitor for TrendFollowing optimization studies.

Usage:
    PYTHONPATH=src python -m libs.models.trend_following.optimization.monitor
"""
...
def main() -> None:
    print("TrendFollowing optimization monitor")
