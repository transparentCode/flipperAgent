"""Phase 7U policy-safe micro-regime separation runner."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = build_transition_micro_separation_report(
        payload,
    ...
    if args.output_md:
        ...
        Path(args.output_md).write_text(render_transition_micro_separation_markdown(report), encoding="utf-8")
    return 0


def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 7U transition micro-regime separation.")
    parser.add_argument("--input-json", default="research/regime_v2_phase7r_transition_setup_prune.json")
    parser.add_argument("--output-json", default="research/regime_v2_phase7u_transition_micro_separation.json")
    parser.add_argument("--output-md", default="research/regime_v2_phase7u_transition_micro_separation.md")
