...
from app.trendlines.workflows.pipeline.data_fetch import fetch_pipeline_workflow_data
...
def _run_pipeline_cli(args) -> int:
    ...
    frames, dataset_manifest = fetch_pipeline_workflow_data(request, quiet=args.quiet)
