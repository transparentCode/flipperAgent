"""MeanReversionModel — RSI + tight Bollinger Bands + ADX regime gate."""
...
class MeanReversionModel(BaseModel):
    ...
    meta = ModelMeta(
        ...
        hyperparameter_schema={
            ...
            "adx_regime_threshold": ParamDef(type="float", default=25.0, low=15.0, high=40.0, step=1.0),
    ...
    def _batch_evaluate_impl(self, feature_df: pd.DataFrame) -> pd.Series:
        ...
        # Recompute entry bands using bb_entry_std
        ...
        # ADX regime gate
        if adx is not None:
            adx_pass = adx < self.params["adx_regime_threshold"]
        else:
            adx_pass = True
