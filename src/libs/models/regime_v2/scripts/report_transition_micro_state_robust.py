"""Offline Phase 7W transition micro-state rolling robustness runner."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.output_md:
        ...
        Path(args.output_md).write_text(render_transition_micro_state_robust_markdown(payload["matrix_report"]), encoding="utf-8")
    return 0
...
async def _run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    matrix = build_transition_micro_state_robust_matrix_report(reports)
    return {
        "phase": "phase_7w_transition_micro_state_robust_runner",
        "asset": args.asset,
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 7W transition micro-state robustness.")
    ...
    parser.add_argument("--output-json", default="research/regime_v2_phase7w_transition_micro_state_robust.json")
    parser.add_argument("--output-md", default="research/regime_v2_phase7w_transition_micro_state_robust.md")
