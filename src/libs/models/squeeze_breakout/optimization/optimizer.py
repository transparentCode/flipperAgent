"""SqueezeBreakout optimization — Optuna objective stub.

Placeholder for future hyperparameter optimization. Deploy with defaults first.
"""
...
def make_objective(
    ...
    """Return an Optuna-compatible objective for SqueezeBreakout."""
