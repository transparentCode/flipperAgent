...
from ..provider import CandidateGenerationStatus, LineCandidateProvider, NativeDeterministicLineProvider, provider_identity
...
class CandidateGeometryEvaluator:
    ...
    def evaluation_spec(self) -> StageEvaluationSpec:
        provider_identity_value = provider_identity(self.provider)
