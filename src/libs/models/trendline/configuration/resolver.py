...
from libs.integrations.trendline_configuration.loader import load_trendline_family_config
...
class TrendlineConfigPatch:
    ...
    def __post_init__(self) -> None:
        ...
        _validate_sections(copied, path="config_patch")
    ...
    def resolve(
        ...
        *,
        ...
        if invocation_override is not None:
            ...
            _validate_sections(override, path="invocation_override")
