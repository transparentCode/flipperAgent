...
def replay_protocol(config: CohortConfig, asset: str) -> ReplayProtocol:
...
def readiness_gates(config: CohortConfig, evaluations: tuple[AssetEvaluation, ...]) -> tuple[tuple[GateRecord, ...], Disposition]:
