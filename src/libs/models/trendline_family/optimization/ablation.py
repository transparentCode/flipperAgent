...
from .evaluator import HoldoutOpenRegistry, evaluate_holdout_once, run_validation_trial
...
class RegimeFeatureAblationEvaluator:
    ...
    def evaluation_spec(self) -> StageEvaluationSpec:
        scorer_identity = f"{self.scorer.__class__.__module__}.{self.scorer.__class__.__qualname__}"
