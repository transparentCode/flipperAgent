"""Explicit ownership and provisional scope for Trendline V2 fields."""
...
_PROVIDER_POLICIES = (
    FieldPolicy("provider.lookback_duration_seconds", "confirmed_extrema_pair", "float_seconds", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
    FieldPolicy("provider.left_confirmation_bars", "confirmed_extrema_pair", "int_bars", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
    FieldPolicy("provider.right_confirmation_bars", "confirmed_extrema_pair", "int_bars", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
    FieldPolicy("provider.min_extrema_per_role", "confirmed_extrema_pair", "int_count", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
    FieldPolicy("provider.max_hypotheses", "confirmed_extrema_pair", "int_count", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
    FieldPolicy("provider.max_output_candidates", "confirmed_extrema_pair", "int_count", FieldClassification.UNRESOLVED, ("global", "timeframe", "asset", "asset_timeframe"), True, True, False, True, "phase_9_scope_study", "fixture_only_unresolved_scope"),
)
...
def provider_field_policies() -> tuple[FieldPolicy, ...]:
    """Active provider fields. Fixed provider semantics are code invariants."""
