...
from flipper_agent.commons.logging.logger_utils import bind_logger, configure_logging
...
def main():
    ...
    uvicorn.run("flipper_agent.ingestion.orchestration.controller:app", host=host, port=port)
