#!/usr/bin/env python
"""Run the RegimeClassification probabilistic calibration ladder."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Probabilistic ladder for RegimeClassification descriptors.",
    )
    ...
    payload = {
        "reports": reports,
        "panel_summary": summarize_probability_panel(reports),
    }
...
def _run_one(
    ...
    *,
    ...
    if args.rolling:
        return run_rolling_probability_ladder(
            frame,
            asset=asset,
            timeframe=timeframe,
            settings=settings,
