"""Tests for the Obscura/CDP CoinGlass probe."""
...
def test_build_obscura_launch_command_defaults():
    assert build_obscura_launch_command() == "obscura serve --host 127.0.0.1 --port 9222"


class TestObscuraCDPInterceptor:
    @pytest.mark.asyncio
    async def test_fetch_heatmaps_uses_cdp_connection(self):
        ...
        interceptor = ObscuraCDPHeatmapInterceptor(endpoint_url="http://127.0.0.1:9999")
